			...
			<div class="d-flex">
				...
				<div class="navbar-brand-box horizontal-logo">
					<a href="#" class="logo logo-dark">
						...
						<span class="logo-lg">
							<img src="{{ asset('public/assets/images/logo-dark.png') }}" alt="" height="25">
						</span>
					</a>
					...
					<a href="#" class="logo logo-light">
						...
						<span class="logo-lg">
							<img src="{{ asset('public/assets/images/logo-light.png') }}" alt="" height="25">
						</span>
					</a>
				</div>
				...
				<button type="button" class="btn btn-sm px-3 fs-15 text-reset header-item d-none d-md-block" data-bs-toggle="modal" data-bs-target="#searchModal">
					<span class="bi bi-search me-2"></span> Search for TradexCombat...
				</button>
			</div>
							...
							<div data-simplebar style="max-height: 300px;" class="pe-2">
								...
								<div class="text-reset notification-item d-block dropdown-item position-relative unread-message">
									<div class="d-flex">
										<div class="position-relative me-3 flex-shrink-0">
											<img src="{{ asset('public/assets/images/users/avatar-2.jpg') }}" class="rounded-circle avatar-xs" alt="user-pic">
								...
								<div class="text-reset notification-item d-block dropdown-item position-relative">
									<div class="d-flex">
										...
										<div class="position-relative me-3 flex-shrink-0">
											<img src="{{ asset('public/assets/images/users/avatar-8.jpg') }}" class="rounded-circle avatar-xs" alt="user-pic">
				...
				<div class="dropdown ms-sm-3 header-item topbar-user">
					<button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						<span class="d-flex align-items-center">
                             @if(!empty(Auth::user()->profile_image) && Storage::disk('public')->exists(Auth::user()->profile_image))
							<img class="rounded-circle header-profile-user" src="{{ asset('storage/app/public/'. Auth::user()->profile_image ) }}" alt="Header Avatar">
                            @else
							...
							<span class="text-start ms-xl-2">
								...
								<span class="d-none d-xl-block ms-1 fs-13 text-reset user-name-sub-text">{{ ucfirst(Auth::user()->userrole) }}</span>
							</span>
						</span>
					</button>
