                                        ...
                                        <div class="col-xl-12">
                                            <div class="card">
                                                <div class="card-header align-items-center d-flex">
                                                    <h4 class="card-title mb-0 flex-grow-1">Recently Pending Withdraw</h4>

													<a href="{{ route('pendingalltransactions', [ 'type' => 'withdrawal']) }}" class="flex-shrink-0 ml-1">View All <i class="ri-arrow-right-line align-bottom ms-1"></i></a>
                                                </div><!-- end card header -->
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive table-card">
														<table class="table table-centered align-middle table-nowrap mb-0" id="currencyTable">
															...
															<tbody>
															@forelse($recentPendingWithdrawals as $data)
