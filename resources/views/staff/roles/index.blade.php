						...
						<div class="row">
							<div class="col-12">
								<div class="page-title-box d-sm-flex align-items-center justify-content-between">
									<h2 class="mb-sm-0">Roles</h4>
                                         {{-- @if(isset($currencyedit) && !empty($currencyedit)) --}}
                                    <div class="flex-shrink-0">
                                        <button type="button" class="btn btn-soft-info btn-md ml-3" data-bs-toggle="modal" data-bs-target="#addRoleModal">
											...
											<div class="card">
												...
												<div class="card-body">
													...
													<div class="table-responsive table-card">
														<table class="table table-centered align-middle table-nowrap mb-0" id="rolesTable">
															...
															@forelse($roles as $data)
																<tr>
																	...
																	<td>
                                                                            ...
                                                                            <a href="javascript:void(0);" class="link-success fs-15 edit-role-btn" data-id="{{ md5($data->id) }}" title="Edit Role">
                                                                                <i class="ri-edit-2-line"></i>
                                                                            </a>
                                                                            <form action="{{ route('deleterole', md5($data->id)) }}" method="POST" class="currency-delete-form" style="display:inline;">
                                                                                @csrf
                                                                                <button type="button" class="btn btn-link p-0 m-0 align-baseline link-danger fs-15 btn-delete-role" title="Delete Role">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalgridLabel">Create/Update Role</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="needs-validation" method="post" action="{{ route('createrole') }}" novalidate>
                    @csrf
                    <div class="row g-3">
                        ...
                        <div class="col-xxl-6">
                            <div>
                                <label for="validationRoleDesc" class="form-label">Description</label>
                                <textarea class="form-control"
                                        name="description"
                                        id="validationRoleDesc"
                        ...
                        <div class="col-xxl-6">
                            <div>
                                ...
                                <select class="form-select" id="validationRoleStatus" name="status" required>
    ...
    $('.edit-role-btn').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    // console.log(data);
                    $('#validationRoleName').val(data.name);
                    $('#validationRoleDesc').val(data.description);
                    $('#validationRoleStatus').val(data.status);

                    $('input[name="role_id"]').val(roleId);

                    $('form').attr('action', '/update_role');
                ...
                error: function () {
                    ...
                    icon: 'error',
                    title: 'Oops...',
                    text: 'Something went wrong while fetching role data!',
