...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h2 class="mb-sm-0">Events And Promotions</h4>
                                    <div class="flex-shrink-0">
                                       <button type="button" class="btn btn-soft-info btn-md ml-3" id="dynamicAddButton"
                                            data-bs-toggle="modal" data-bs-target="#addPromotionsModal">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="text-end flex-grow-1">
                                                    ...
                                                    <h4 class="fs-22 fw-semibold mb-3"><span class="counter-value"
                                                            data-target="{{ $promotions->count() }}">{{ $promotions->count() }}</span> </h4>
                                                </div>
                                            </div>
                                        </div><!-- end card body -->
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <ul class="nav nav-tabs nav-justified mb-3" role="tablist">
                                                {{-- <li class="nav-item">
                                                    <a class="nav-link active" data-bs-toggle="tab" href="#tournaments"
                                                        role="tab" aria-selected="true" data-modal="#addTournamentModal">
                                                        Tournaments
                                                    </a>
                                                </li> --}}
                                                <li class="nav-item">
                                                    <a class="nav-link" data-bs-toggle="tab" href="#promotions"
                                                        role="tab" aria-selected="false" data-modal="#addPromotionsModal">
                                                        Promotions
                                                    </a>
                                                </li>
                                            </ul>
                                                                            ...
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div class="table-responsive table-card">
                                                                                    <table class="table table-centered align-middle table-nowrap mb-0"
                                                                                        ...
                                                                                        <tbody>
                                                                                            @forelse($promotions as $data)
                                                                                                <tr>
                                                                                                    <td>{{ $loop->iteration }}</td>

                                                                                                    <td>{{ ucfirst($data->coupon_type) }}</td>
                                                                                                    <td>{{ ucfirst($data->coupon_code) }}</td>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        @if ($data->is_active == 1)
                                                                                                            <span
                                                                                                                class="badge text-success  bg-success-subtle">Active</span>
                                                                                                        @else
                                                                                                            <span
                                                                                                                class="badge text-danger  bg-danger-subtle">Inactive</span>
                                                                                                        @endif
                                                                                                    </td>
                                                                                                    <td>{{ \Carbon\Carbon::parse($data->expiry_date)->format('d F Y') }}</td>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        <a href="javascript:void(0);" class="link-success fs-15 edit-promotion-btn" data-id="{{ md5($data->id) }}" title="Edit Promotion">
                                                                                                                <i class="ri-edit-2-line"></i>
                                                                                                            </a>
                                                                                                        <form
                                                                                                            action="{{ route('deletePromotion', md5($data->id)) }}"
                                                                                                            method="POST" class="currency-delete-form"
                                                                                                            style="display:inline;">
                                                                                                            @csrf
                                                                                                            <button type="button"
                                                                                                                class="btn btn-link p-0 m-0 align-baseline link-danger fs-15 btn-delete-promotion"
    ...
    <div class="modal fade" id="addPromotionsModal" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalgridLabel">Create/Update Promotions</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="needs-validation" method="post" action="{{ route('createPromotion') }}" novalidate enctype="multipart/form-data">
                        @csrf
                        <div class="row g-3">
                            ...
                            <div class="col-xl-6">
                                ...
                                <input type="text" class="form-control" name="coupon_type" id="couponType"
                                    placeholder="Enter Coupon Type" required value="{{ old('coupon_type') }}">
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">Please enter Coupon Type.</div>
                            </div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <input type="text" class="form-control" name="coupon_code" id="couponCode"
                                    placeholder="Enter Coupon Code" required value="{{ old('coupon_code') }}">
                                <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <input type="number" step="0.01" class="form-control" name="percentage" id="percentage"
                                    placeholder="Enter Percentage" required value="{{ old('percentage') }}">
                                <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <input type="date" class="form-control" name="expiry_date" id="expiryDate"
                                    required value="{{ old('expiry_date', isset($data->expiry_date) ? \Carbon\Carbon::parse($data->expiry_date)->format('Y-m-d') : '') }}">
                                <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <input type="file" class="form-control" name="file_path" id="filePath" required />
                                <div class="valid-feedback">Looks good!</div>
                                <div id="uploadedFilePreview" class="mt-2">
                                    <img src="" id="editPromotionPreview" class="avatar-md" style="max-height: 150px; display: none;">
                                </div>
                            </div>
                            ...
                            {{-- Hidden Field --}}
                            <input type="hidden" name="promotion_id" value="{{ old('promotion_id') }}">
     ...
     {{-- <div class="modal fade" id="addTournamentModal" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalgridLabel">Create/Update Tournaments</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="needs-validation" method="post" action="{{ route('createNews') }}" novalidate
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div id="uploadedFilePreview" class="mt-2">
                                    <img src="" id="editNewsPreview" class="avatar-md"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit-promotion-btn', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        console.log(data);
                        $('#couponType').val(data.coupon_type);
                        $('#couponCode').val(data.coupon_code);
                        $('#expiryDate').val(data.expiry_date.split(' ')[0]);
                        $('#percentage').val(data.percentage);
                        $('#isActive').val(data.is_active);
                        $('input[name="promotion_id"]').val(promotionId);
                        ...
                        if (data.file_path) {
                            $('#editPromotionPreview')
                                .attr('src', 'storage/app/public/' + data.file_path)
                                .show();
                        } else {
                            $('#editPromotionPreview').hide();
                        }

                        $('form').attr('action', '/update_promotion');
                        if (promotionId) {
                            $('#filePath').removeAttr('required');
                        } else {
                            $('#filePath').attr('required', 'required');
                        }


                        $('#addPromotionsModal').modal('show');
                    },
                    error: function() {
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            text: 'Something went wrong while fetching Promotion data!',
                        });
                    }
                });
            });
            ...
            $('#addPromotionsModal').on('hidden.bs.modal', function() {
                $(this).find('form')[0].reset();

                $(this).find('input[name="promotion_id"]').val('');

                $(this).find('input[name="expiry_date"]').val('');

                $(this).find('#editPromotionPreview').attr('src', '').hide();
        ...
        document.querySelectorAll('.nav-tabs .nav-link').forEach(tab => {
            tab.addEventListener('click', function () {
                ...
                const addButton = document.getElementById('dynamicAddButton');
                addButton.setAttribute('data-bs-target', modalTarget);
            });
        });
    </script>
@endsection
